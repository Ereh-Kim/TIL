...
class Singly_Linked_List_Node {
    ...
    constructor( Next_Node, headValue ){
        this.Next_Node = Next_Node
        this.headValue = headValue
        this.intro = `i am ${this.headValue}`
    }
...
console.log(`B2 을 Next_Node 로 ${B2.Next_Node.headValue} 와 새롭게 연결했습니다`)
console.log(`B1 의 Next_Node 로 ${B1.Next_Node.headValue} 와 새롭게 연결했습니다`)

console.log(` B2 를 추가해서 새롭게 연결한 이후, `)
console.log(` C1 => ${C1.Next_Node.headValue} => ${B1.Next_Node.headValue} => ${B2.Next_Node.headValue} 순으로 연결되었습니다 `)

// singly_linkedlist 가 기존의 node 를 삭제하는 과정

B2.Delete_Node( A1, B1 )

console.log(`B1 의 Next_Node 로 ${B1.Next_Node.headValue} 와 새롭게 연결으로써`)
